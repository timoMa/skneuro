...
#rpathI = "/home/tbeier/Desktop/smoothed_2.0_10_4_1_90_80.h5"
...
if True:
    ...
    print "run"
    t0 =time()
    policy = vigra.filters.RatioPolicy(sigma=5.0, meanRatio=0.90, varRatio=0.80)
    #policy = vigra.filters.NormPolicy(sigma=50.0, meanDist=50, varRatio=0.5)
    res = vigra.filters.nonLocalMean3d(data, policy=policy,searchRadius=10,patchRadius=3,nThreads=13,stepSize=2,verbose=True,sigmaMean=1.0)
    t1 = time()
...
if True:   
    ...
    #resI = vigra.readHDF5(rpathI, 'data')
    ...
    #v.addGrayscaleLayer(resI, name="smoothed 2.0  10  4 1 -- 90 80")
